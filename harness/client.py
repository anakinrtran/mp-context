...
def make_ollama_judge(client: OllamaClient) -> JudgeFn:
    ...
    def judge(rubric_text: str, criteria: str, eval_prompt: str,
        ...
        judge_system = (
            "You are an impartial grader. Read the rubric, the customer "
            "message, and the bot's response. Return exactly one JSON object: "
            '{"pass": true|false, "reason": "one short sentence"} — no '
