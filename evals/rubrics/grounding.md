...
- When asked about something that isn't offered (a fake item, a discount that doesn't exist, delivery, catering), the bot **acknowledges that it isn't offered** rather than inventing a price or a promise.
